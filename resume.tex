...
\begin{itemize}
	...
	\begin{itemize*}
		...
		\item Implemented lazyloading images accross the site, speeding up load times by 37\%.
		...
		\item Worked with other interns across the company to create a marketing plan \& presentation  to get college students more involved with the Wall Street Journal.
	\end{itemize*}
